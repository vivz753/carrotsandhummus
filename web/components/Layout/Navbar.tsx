...
export const Navbar: FC = () => {
  return (
    <div className="absolute top-0 z-20 flex h-20 max-h-20 w-full flex-row items-center justify-start gap-5 bg-p5 px-5 sm:px-12">
      <Link href="/" className=" flex h-12 w-24 flex-row justify-center sm:h-full sm:w-64">
        <div className="relative h-12 w-28 sm:h-full sm:w-36">
          <Image
            fill
        ...
        <div className="relative hidden h-12 w-12 sm:block sm:h-full sm:w-20">
          <Image
            fill
            style={{ objectFit: "cover" }}
            alt="carrots and hummus logo"
